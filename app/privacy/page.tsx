  ...
  return (
    <Container>
      <div className="p-4 space-y-4">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Korner Kick.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Korner Kick, accessible from{" "}
              <a
                href="https://kornerkick.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://kornerkick.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: kornerkick@gmail.com</li>
        </ul>
      </div>
    </Container>
  );
